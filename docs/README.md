...
| [Settings Reference](settings.md) | Complete Settings window documentation |
| [Toolkit Reports & Dialogs](toolkit-reports-and-dialogs.md) | Result sheets, alerts, fictional sample logs |
| [Operator Guide](operator-guide.md) | Menu bar, workflows, MDM |
...
| Page | Description |
|------|-------------|
| [Project Overview](project-overview.md) | Purpose and limitations |
| [Architecture](architecture.md) | App design and data flow |
